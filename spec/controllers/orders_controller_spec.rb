...
describe OrdersController do
  ...
  let(:valid_attributes) { { "barcode" => "MyString" } }
  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved order as @order" do
        ...
        post :create, {:order => { "barcode" => "invalid value" }}, valid_session
        expect(assigns(:order)).to be_a_new(Order)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested order" do
        ...
        expect_any_instance_of(Order).to receive(:update).with({ "barcode" => "MyString" })
        put :update, {:id => order.to_param, :order => { "barcode" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the order as @order" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Order.any_instance.stub(:save).and_return(false)
        put :update, {:id => order.to_param, :order => { "barcode" => "invalid value" }}, valid_session
        expect(assigns(:order)).to eq(order)
      end
